...
const bootstrapIconArrow90DegUp = `
  ...
  <nav class="nav">
    <div class="l-wrapper">
      ...
      <div class="nav-buttons">
        <button class="nav-button">${bootstrapIconArrow90DegUp}More Guides</button>
        <button class="nav-button" id="all-sections-button">${bootstrapIconBook}Chapters</button>
        <button class="nav-search-button">${bootstrapIconSearch}<span class="sr-only">Search</span></button>
      </div>
    </div>
  </nav>
