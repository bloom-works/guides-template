...
${Callout({'content': '<p>Online whiteboarding tools like Mural and Miro are not the most accessible tools. Please check in with your team to make necessary accommodations.</p>'})}
...
${Callout({'content': '<p>Here’s an example of turning a story into a solid recommendation.</p> <p><strong>Story:</strong> Kin caregivers that had legal support expressed how much of a positive difference it made</p><p><strong>Recommendation:</strong> Develop partnerships to provide independent, free or affordable legal support to kin families.</p>'})}${Checklist({
...
${Callout({'content': '<p>Sometimes research can be purely transactional, and your client may not want to be involved in workshopping recommendations, and that’s fine! Find an approach that works best for your client relationship!</p>'})}
...
${Callout({'content': '<p>Remember that folks that might have different usability needs might access them now or in the future. Diagrams and virtual whiteboards are lovely, but should be complements to plain-language text.</p>'})}
